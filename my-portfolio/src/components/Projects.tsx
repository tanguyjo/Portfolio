...
const projects = [
  ...
  },
  {
    ...
    images: ["HomePage.png", "HomePageMeubles.png","meuble3.png","meuble4.png","meuble5.png","meuble6.png","Panier.png"],
    description: (
  <>
...
const ProjectCard = ({ project }) => {
  ...
  // fonctions prevImage, nextImage, openModal, closeModal inchangées
  const prevImage = () => {
...
<section style={styles.section} id="projects">
  <div style={{ textAlign: 'center' }}> {/* Wrapper pour centrer */}
    <div
